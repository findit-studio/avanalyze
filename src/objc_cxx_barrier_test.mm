 ...
 * same one.
 */
@interface Avanalyze_0_7_TestUndescribableException : NSException
@end

@implementation Avanalyze_0_7_TestUndescribableException
- (NSString *)reason {
 ...
 */
@interface Avanalyze_0_7_TestSentinel : NSObject
@end

static int32_t g_avanalyze_test_sentinel_deallocations = 0;

@implementation Avanalyze_0_7_TestSentinel
- (void)dealloc {
 ...
 */
void avanalyze_0_7_test_autorelease_sentinel(void) {
  [[[Avanalyze_0_7_TestSentinel alloc] init] autorelease];
}
 ...
 */
int32_t avanalyze_0_7_test_sentinel_deallocations(void) {
 ...
 * `catch (...)` has come back.
 */
void avanalyze_0_7_test_throw(int32_t kind) {
  switch (kind) {
    ...
    case AVANALYZE_TEST_THROW_UNDESCRIBABLE_NSEXCEPTION:
      @throw [Avanalyze_0_7_TestUndescribableException
