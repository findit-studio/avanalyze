 ...
 */
@interface Avanalyze_0_7_TestPoint3D : NSObject
- (simd_float4x4)position;
@end

@implementation Avanalyze_0_7_TestPoint3D
- (simd_float4x4)position {
 ...
 * one.
 */
id avanalyze_0_7_test_point3d_new(void) {
  return [[Avanalyze_0_7_TestPoint3D alloc] init];
}
